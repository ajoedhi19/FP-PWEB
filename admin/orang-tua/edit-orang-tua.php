        ...
        <section class="mb-4 d-flex flex-column align-items-center justify-content-center">
            <article class="col-md-6 text-left">
                <form action="proses-edit-orang-tua.php" onsubmit="return submitForm()" method="POST">
                    ...
                    <input type="hidden" name="parent_of" id="parent_of" value="<?php echo $ortu[
                      "parent_of"
                    ]; ?>">

                    <div class="form-group my-2">
                        <label for="name">Name</label>
                        <input type="text" name="name" class="form-control rounded" placeholder="Name" value="<?php echo $ortu[
                          "name"
                        ]; ?>" required />
                    </div>
                    ...
                    <div class="form-group my-2">
                        ...
                        <input class="form-control" type="date" name="date_of_birth" placeholder="Date of Birth" value="<?php echo $ortu[
                          "date_of_birth"
                        ]; ?>" required></input>
                    </div>
                    ...
                    <div class="form-group my-2">
                        ...
                        <textarea name="address" class="form-control" placeholder="Address" style="width: 100%; height: 150px" required><?php echo $ortu[
                          "address"
                        ]; ?></textarea>
                    </div>
                    ...
                    <div class="form-group my-2">
                        ...
                        <input class="form-control" type="tel" name="phone_number" placeholder="Phone Number" value="<?php echo $ortu[
                          "phone_number"
                        ]; ?>" required></input>
                    </div>
                    ...
                    <div class="form-group my-3">
                        ...
                        <a class="btn btn-danger" href="proses-hapus-orang-tua.php?id=<?php echo $ortu[
                          "id"
                        ]; ?>">Delete</a>
                    </div>

                    <input type="hidden" name="id" value="<?php echo $ortu[
                      "id"
                    ]; ?>" required />
                </form>
            </article>
            <a class="btn btn-primary" href="./list-orang-tua.php">Back</a>
        </section>
