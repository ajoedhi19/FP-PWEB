...
if (mysqli_num_rows($query) < 1) {
    header('Location: list-orang-tua.php?status=gagal&msg=Data%20tidak%20ditemukan');
}
                ...
                <form action="proses-edit-orang-tua.php" onsubmit="return submitForm()" method="POST">
                    <div class="form-group my-2">
                        ...
                        if (mysqli_num_rows($queryChild) < 1) {
                            header('Location: list-orang-tua.php?status=gagal&msg=Data%20anak%20tidak%20ditemukan');
                        } else {
                    ...
                    <div class="form-group my-3">
                        ...
                        <a class="btn btn-danger" href="proses-hapus-orang-tua.php?id=<?php echo $ortu['id'] ?>">Delete</a>
                    </div>
